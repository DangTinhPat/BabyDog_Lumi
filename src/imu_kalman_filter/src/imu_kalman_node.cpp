...
public:
  ...
  : Node("imu_kalman_filter")
  {
    ...
    if (axis_map.size() != 3U || axis_sign.size() != 3U) {
      throw std::invalid_argument("axis_map and axis_sign must each contain exactly 3 values");
    }
...
private:
  ...
  void publish_diagnostics()
  {
    ...
    status.name = "babyDog/imu_kalman";
